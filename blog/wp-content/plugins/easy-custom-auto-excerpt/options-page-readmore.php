	...
	<div class="inside" style="z-index:1;">
		<table class="form-table">
			...
			$text_after_content = array(
				...
				'description' => __( 'The text located right after your content, for example dots <code>[...]</code>. You can also styling the text by css with selector <code>.ecae-dots</code>', 'easy-custom-auto-excerpt' ),
			);

			$readmore_inline = array(
				'name'         => 'tonjoo_ecae_options[readmore_inline]',
				'description'  => __( "If you select 'yes', the readmore button will inline with the last paragraph", 'easy-custom-auto-excerpt' ),
			...
			$readmore_display = array(
				...
				'description'  => __( 'Normal mode = show readmore button, only if content length is bigger than excerpt size', 'easy-custom-auto-excerpt' ),

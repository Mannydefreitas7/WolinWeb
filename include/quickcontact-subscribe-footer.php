...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	if( $_POST['quick-contact-form-email'] != '' ) {
		...
		$company = $_POST['quick-contact-form-company'];
		$find = $_POST['quick-contact-form-find'];
		$plan = $_POST['quick-contact-form-plan'];
		$template = $_POST['quick-contact-form-template'];
		$message = $_POST['quick-contact-form-message'];
		$subscribe_email = $email;

		$subject = 'Home Footer Contact Form';
		...
		if( $botcheck == '' ) {
			...
			$company = isset($company) ? "Company Name: $company<br><br>" : '';
			$plan = isset($plan) ? "Service: $plan<br><br>" : '';
			$template = isset($template) ? "Service: $template<br><br>" : '';
			$message = isset($company) ? "Message: $message<br><br>" : '';
			$find = isset($find) ? "Message: $find<br><br>" : '';

			$referrer = $_SERVER['HTTP_REFERER'] ? '<br><br><br>This Form was submitted from: ' . $_SERVER['HTTP_REFERER'] : '';

			$body = "$fname $lname $email $phone $message $company $template $plan $find $referrer ";

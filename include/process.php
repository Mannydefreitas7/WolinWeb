...
$options['from_address']        = 'contact@wolinweb.com';               // Address the email is sent from
$options['from_name']           = 'WolinWeb';                              // Name to attach to the address
$options['to_addresses']        = array( 'contact@wolinweb.com' );               // To: addresse(s), add new array item for more
$options['bcc_addresses']       = array( 'manny.defreitas7@me.com' );               // BCC: addresse(s), add new array item for more
 ...
 */
 function getHtmlEmailContent()
 {
   ...
   $content = '';
	...
	$content .=   '.title { width: 100%; background-color: #ccc; height: auto; height: 100px; }';
	$content .=   '.title h3 { text-align: center; color: #333; font-weight: 400; font-size: 30px; line-height: 100px; vertical-align: middle; }';
 	$content .= '</style>';
	$content .= '<div class="title"><h3>New Website Form Submission!</h3></div>';
